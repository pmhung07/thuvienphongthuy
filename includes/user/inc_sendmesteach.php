<?php
    $mes_true = 0;
    $db2 = new db_query("SELECT * FROM mesclass WHERE mesclass_teacher =".$myuser->u_id);
...
<div class="user-manager-info">
    <div class="block-content-show-content">
        <div class="block-content-info">
            <div class="notice-update-info">TIN NHẮN ĐÃ GỬI</div>
            <?
            if($mes_true == 1){ 
                foreach($arrclassMes as $key=>$value){
                    ...
                    <div class="listmes">
                        ...
                        ?>
                        <div class="listmesteacher">TIN NHẮN BẠN ĐÃ GỬI <span></span></div>
