	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: 'js/images/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'js/images/progressbg_red.gif',
									30: 'js/images/progressbg_orange.gif',
									70: 'js/images/progressbg_green.gif'
								},
