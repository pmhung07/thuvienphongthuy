...
$myform->add("toque_part" , "toque_part" , 1 , 1 , 1 , 0,"" , 0 , "");
         ...
         if($fs_errorMsg == ""){
            ...
            if($last_exe_id>0){
               ...
               for($i=0;$i<4;$i++){
                  ...
                  //$ans_form->add("totan_true" , "true" , 1 , 1 , 0 , 0,"Bạn chưa nhập câu trả lời đúng" , 0 , "");
...
<body> 
   ...
   <div id="wr_list_answer">       
      ...
      <table class="table_info_exe">
         ...
         <?
         $db_ques_select   = new db_query("SELECT * FROM  toeic_questions WHERE toque_toty_id = ". $record_id ." AND toque_part = 1 ORDER BY toque_order");
         $i = 0;
