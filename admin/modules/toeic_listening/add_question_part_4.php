...
$myform->add("toque_part" , "toque_part" , 1 , 1 , 4 , 0,"" , 0 , "");
...
<body>
   ...
   <div id="wr_list_answer">
      ...
      <table class="table_info_exe">
         ...
         <?
         $db_ques_select   = new db_query("SELECT * FROM  toeic_questions WHERE toque_toty_id = ". $record_id ." AND toque_part = 4 ORDER BY toque_order");
         $i = 0;
...
.a_score{margin: 7px 0px 5px 0px;text-decoration: none;background: green;height: 18px;color: white;line-height: 18px;padding: 0px 5px;}
</style>
<script>
