...
checkAddEdit("add");
   ...
   if($iTyp > 0){
      $db_check_type = new db_query("SELECT iety_id FROM ielt_type WHERE iety_ielt_i = ". $iTyp ." AND iety_type = 1");
...
<? /*------------------------------------------------------------------------------------------------*/ ?>
   ...
   <?=$form->text("Tên phần thi", "iety_name", "iety_name", "Reading", "Phần thi", 1, 272, "", 255, "", "", "")?>
