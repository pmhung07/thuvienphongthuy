...
checkAddEdit("edit");
	...
	$myform->removeHTML(0);
	$myform->add("scat_type","scat_type", 0, 0,"", 1, translate_text("Vui lòng chọn loại danh mục!"),0,"");
	$myform->add("scat_name","scat_name", 0, 0, "", 1, translate_text("Vui lòng nhập tên danh mục"),0,"");
	if($array_config["order"]==1)  $myform->add("scat_order","scat_order", 1, 0, 0,0,"",0,"");
	if($array_config["upper"]==1) $myform->add("scat_parent_id","scat_parent_id", 1, 0, 0, 0, "", 0, "");
	$myform->add("admin_id","admin_id", 1, 1, 0, 0, "", 0, "");
	//Active data
	$myform->add("scat_active","active", 1, 1, 1, 0, "", 0, "");
	//Add table
