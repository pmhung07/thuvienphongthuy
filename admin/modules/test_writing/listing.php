...
$total			= new db_count("SELECT count(*) AS count FROM type_test
                               ...
                               WHERE typ_type = 4 ".$list->sqlSearch());
...
<div id="listing">
   ...
   ?>
      ...
      <td width="150px" align="center">
         <? echo'<a title="Thêm paragraph" class="thickbox noborder a_detail" href="add_paragraph.php?url='. base64_encode(getURL()) . '&record_id=' . $row["typ_id"] .'&TB_iframe=true&amp;height=450&amp;width=900" /><b>Add Paragraph</b></a>';?>
      </td>
      <?/*
      <td align="center" width="80px">
          <?
          $url = $data_path.$row["typ_direct_audio"];
