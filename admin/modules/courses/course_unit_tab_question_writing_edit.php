...
$myform->add("cou_tab_question_order", "cou_tab_question_order", 1, 0, "", 0, "", 0, "");
...
<?=template_top($fs_title)?>
   <p align="center" style="padding-left:10px;">
      ...
      $form->create_table();
      ?>
      <?=$form->text("Tiêu đề", "cou_tab_question_title", "cou_tab_question_title", $cou_tab_question_title, "Tiêu đề", 0, 489, 20, 255, "", "", "")?>
      <?//=$form->textarea("Nội dung dạng bài tập", "cou_tab_question_content", "cou_tab_question_content", $cou_tab_question_content, "Nội dung", 0, 500, 20, 255, "", "", "style='resize:none;'")?>
      <tr>
      <td class="form_name">Nội dung bài tập :</td>
      <td class="form_text">
      <textarea class="cou_tab_question_content" id="cou_tab_question_content" name="cou_tab_question_content" style="width:500px;height: 50px;"><?=$cou_tab_question_content?></textarea>
      ...
      <?=$form->text("Thứ tự", "cou_tab_question_order", "cou_tab_question_order", $cou_tab_question_order, "Tiêu đề", 0, 489, 20, 255, "", "", "")?>
