...
checkAddEdit("add");
   ...
   $iCate =  $dbcate['cat_id'];
   if($dbcate){
      $link = generate_preview_link($nCate,$dbcate['lev_name'],$nLesson,$nCourse,$iCoirse,'main');
   }
...
<?=$load_header?>
   ...
   <? /*------------------------------------------------------------------------------------------------*/ ?>
      ...
      <tr>
         <td align="right" style="font-size: 12px; font-weight:bold; color:#004000;">Chọn kiểu bài học chính :</td>
         <td align="left">
      ...
      <tr>
         <td colspan="2">
         <?=$form->wysiwyg("<font class='form_asterisk'>*</font> Nội dung tiếng anh", "main_content_en", $main_content_en, "../../resource/wysiwyg_editor/", 800, 250)?>
         </td>
      </tr>
      <tr>
         <td colspan="2">
         <?=$form->wysiwyg("<font class='form_asterisk'>*</font> Nội dung tiếng việt", "main_content_vi", $main_content_vi, "../../resource/wysiwyg_editor/", 800, 250)?>
         </td>
      </tr>
      ...
      <tr <? if($i%2==0) echo ' bgcolor="#FAFAFA"';?>>
         ...
         <td align="center"><a class="text" href="editdetail.php?record_id=<?=$row["main_id"]?>&returnurl=<?=base64_encode(getURL())?>"><img src="<?=$fs_imagepath?>edit.png" alt="EDIT" border="0"></a></td>
