...
$db_select = new db_query("SELECT lib_cat_id FROM " . $fs_table . " WHERE lib_cat_parent_id =" . $record_id);
...
//Delete data with ID
delete_file($fs_table,"lib_cat_id",$record_id,"lib_cat_picture",$imgpath);
$db_del = new db_execute("DELETE FROM ". $fs_table ." WHERE lib_cat_id =" . $record_id);
unset($db_del);
