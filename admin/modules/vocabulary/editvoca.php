...
checkAddEdit("edit");
   ...
   $voc_det_id = getValue("voc_det_id","str","GET","");
   
   $db_dataVoca = new db_query("SELECT les_com_id,les_det_id,com_cou_id,com_id FROM  lesson_details,courses_multi 
   ...
   while($rowC = mysql_fetch_array($db_dataVoca->result)){
      ...
      $db_course = new db_query("SELECT courses.cou_cat_id,courses.cou_id FROM  courses,courses_multi
   ...
   $myform->add("les_det_type", "les_det_type", 1, 0, 3, 0, "Bạn chưa chọn Lesson", 0, "");
