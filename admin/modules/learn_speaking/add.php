...
checkAddEdit("add");
   ...
   ($com_cou_id != 0) ? $com_c_id = $com_cou_id : $com_c_id = 0;
   $com_c_id;
   ...
   if($com_c_id > 0){
      ...
      $unit_select = new db_query("SELECT com_id,com_name FROM courses_multi 
                                    WHERE com_cou_id = " .$com_c_id. " AND com_active = 1");
...
<? /*------------------------------------------------------------------------------------------------*/ ?>
    ...
    <tr>
        ...
        <td>
           <select class="form_control" style="width: 186px;" name="learn_unit_id" id="learn_unit_id">
    ...
    <? //$form->text("Câu hỏi","learn_sp_ques","learn_sp_ques",$learn_sp_ques,"Câu hỏi",0,250,22)?>
