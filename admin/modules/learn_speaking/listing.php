		...
		<input type="hidden" name="iQuick" value="update" />
         ...
         ?>
            ...
            if($cou_id == $rowCourse['cou_id']){
               ...
               $dlUnut .= '<td align="center"><a class="text" href="editgram.php?record_id='.$rowUnit["learn_sp_id"].'&returnurl='.base64_encode(getURL()).'"><img src="'.$fs_imagepath.'edit.png" alt="EDIT" border="0"></a></td>';
               $dlUnut .= '<td align="center"><img src="'.$fs_imagepath.'delete.gif" alt="DELETE" border="0" onClick="if (confirm(\'Are you sure to delete?\')){ window.location.href=\'deletegram.php?record_id='.$rowUnit["learn_sp_id"].'&returnurl='.base64_encode(getURL()).'\'}" style="cursor:pointer"></td>';
               $dlUnut .= '</tr>';
               }
               echo $dlUnut;
            }
