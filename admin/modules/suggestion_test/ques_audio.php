...
if($action == "execute"){
   if($fs_errorMsg == ""){
      ...
      if($filename_img != ""){
         delete_file("sg_test_questions","sg_ques_id",$iQues,"sg_ques_image",$image_path);
...
<?=template_top($fs_title)?>
   <p align="center" style="padding-left:10px;">
      ...
      $form->create_table();
      ?>
      <?=$form->getFile("Tải Audio", "sg_ques_audio", "sg_ques_audio", "Tải audio", 0, 30, "", "")?>
	...
	<table cellpadding="5" cellspacing="0" width="450px" style="border-collapse:collapse;" bordercolor="#CCCCCC" border="1">
      ...
      $db_picture = new db_query("SELECT * FROM sg_test_questions WHERE  sg_ques_id = ".$iQues);
		...
		?>
            ...
            <?$url = $data_path.$row['sg_ques_audio'];?>
            <?$url_img = $image_path.$row['sg_ques_image'];?>
