...
$tit_ques   = getValue("tit_ques","str","POST","");
...
$myform->add("sg_ques_title" , "tit_ques" , 0 , 1 , "" , 0,"" , 0 , "");
$myform->add("sg_ques_content" , "question" , 0 , 1 , "" , 0,"" , 0 , "");
$myform->add("sg_ques_order" , "sg_ques_order" , 1 , 0 , 0 , 0,"" , 0 , "");
...
$myform->addTable("sg_test_questions");
   ...
   if($action == "execute"){
      ...
      if($fs_errorMsg == ""){
         ...
         if($filename_img != ""){
         	$myform->add("sg_ques_image","filename_img",0,1,0,0);
         ...
         if($fs_errorMsg == ""){
            ...
            if($last_exe_id>0){
               ...
               for($i=0;$i<4;$i++){
                  ...
                  $ans_form->addTable("sg_test_answers");
...
<body> 
   ...
   ?>
   <tr>
      <td width="160px" class="form_name">Nhập tiêu đề câu hỏi :</td>
      <td><input type="text" name="tit_ques" id="tit_ques" class="form_control" style="width: 250px;" value="" /></td>
   </tr>
   <tr>
      <td width="160px" class="form_name">Nhập nội dung câu hỏi :</td>
      <td><input type="text" name="question" id="question" class="form_control" style="width:250px;" value=""/></td>
   </tr>
   <tr>
      <td width="160px" class="form_name">Nhập câu trả lời :</td>
      <td>
