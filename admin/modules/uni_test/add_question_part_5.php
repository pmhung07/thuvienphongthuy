...
$myform->add("toque_part" , "toque_part" , 1 , 1 , 5 , 0,"" , 0 , "");
...
<body> 
   ...
   <div id="wr_list_answer">       
      ...
      <table class="table_info_exe">
         ...
         <?
         $db_ques_select   = new db_query("SELECT * FROM  toeic_questions WHERE toque_toty_id = ". $record_id ." AND toque_part = 5 ORDER BY toque_order");
         $i = 0;
