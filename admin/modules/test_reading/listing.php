...
$list->add("tec_content","Add Paragraph","string", 0, 0);
...
$total			= new db_count("SELECT count(*) AS count FROM type_test
                               ...
                               WHERE typ_type = 1 ".$list->sqlSearch());
...
<div id="listing">
   ...
   ?>    
      ...
      <td width="300px" style="color: red;">
         <table>
            <tr>
               <td width="">Phần thi :</td>
               <td><input style="color: red;font-weight: bold;font-size: 11px;" readonly="" type="text" value="<?=$row['typ_name']?>" /></td>
            </tr>
            <tr>
               <td width="">Thuộc đề thi :</td>
               <td><input style="color: blue;font-weight: bold;font-size: 11px;" readonly="" type="text" value="<?=$row['test_name']?>" /></td>
            </tr>
         </table>
      </td>
      </td>
      <td width="400px" align="center">
          <textarea style="width: 400px;height: 40px;">Phần hướng dẫn này sẽ được fix cứng,không cần quan tâm.Phần hướng dẫn này sẽ được fix cứng,không cần quan tâm.
          </textarea>
      </td>
      <td width="150px" align="center">
         <? echo'<a title="Thêm paragraph" class="thickbox noborder a_detail" href="add_paragraph.php?url='. base64_encode(getURL()) . '&record_id=' . $row["typ_id"] .'&TB_iframe=true&amp;height=450&amp;width=1000" /><b>Add Paragraph</b></a>';?>
      </td>
      <td width="150px" align="center">
