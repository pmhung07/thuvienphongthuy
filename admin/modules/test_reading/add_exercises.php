...
while($row_para = mysql_fetch_assoc($db_para_select->result)){
            ...
            <table class="table_info_exe">
               ...
               <tr style="background: #A9BAD0;">
                  ...
                  <td>
                     ...
                     if($row_ans = mysql_fetch_assoc($db_ans_select->result)){
            ...
            <table class="table_info_exe">
               ...
               <tr style="background: #A9BAD0;">
                  ...
                  <td>
                     ...
                     while($row_quessub = mysql_fetch_assoc($db_quessub_select->result)){
                     ?>
                    ...
                    ----------------------------------------- Câu trả lời sai ------------------------------------------
                     ...
                     while($row_ans_false = mysql_fetch_assoc($db_ans_false_select->result)){?>
