...
$true_drag_5 = getValue("true_drag_5","str","POST","");
$true_drag_6 = getValue("true_drag_6","str","POST","");
$question   = getValue("question","str","POST","");
$arr_ans    = array($ans_1,$ans_2,$ans_3,$ans_4,$ans_5,$ans_6);
$arr_true   = array($true_drag_1,$true_drag_2,$true_drag_3,$true_drag_4,$true_drag_5,$true_drag_6);
$teque_type_sub = 1;
//=========================//
$fs_errorMsg = "";
...
$myform->add("teque_type_sub" , "teque_type_sub" , 1 , 1 , 1 , 0,"" , 0 , "");
if($fs_errorMsg == ""){
	if($fs_errorMsg == ""){
