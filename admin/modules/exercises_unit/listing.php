...
$total			= new db_count(" SELECT count(*) AS count FROM 	" .$fs_table. "
                                ...
                                INNER JOIN courses ON com_cou_id = cou_id WHERE 1 AND exe_type = 0". $list->sqlSearch() . $sql_filter);
   	...
   	<td width="300" align="center">
         <table width="290px">
   	      ...
   	      <tr>
   				...
   				<td><input style="color: red;" type="text" size="30" readonly="" class="form_control" value="<?=$row['com_name']?>" /></td>
            </tr>
   	 	</table>
      </td>
