...
$list->add("tec_audio","Add Paragraph","string", 0, 0);
...
$total			= new db_count("SELECT count(*) AS count FROM ielt_type
                               ...
                               WHERE iety_type = 1 ".$list->sqlSearch());
...
<div id="listing">
   ...
   ?>    
      ...
      <td width="150px" align="center">
         <? echo'<a title="Thêm Audio" class="thickbox noborder a_detail" href="add_paragraph.php?url='. base64_encode(getURL()) . '&record_id=' . $row["iety_id"] .'&TB_iframe=true&amp;height=450&amp;width=1000" /><b>Add Paragraph</b></a>';?>
      </td>
      <td width="150px" align="center">
