...
$list->add("part_5","Part 5","string", 0, 0);
$list->add("part_6","Part 6","string", 0, 0);
$list->add("part_7","Part 7","string", 0, 0);
...
$total			= new db_count("SELECT count(*) AS count FROM toeic_type
                               ...
                               WHERE toty_type  = 1 ".$list->sqlSearch());
...
<div id="listing">
   ...
   ?>    
      ...
      <td width="150px" align="center">
         <? echo'<a title="Thêm Part 5" class="thickbox noborder a_detail" href="add_question_part_5.php?url='. base64_encode(getURL()) . '&record_id=' . $row["toty_id"] .'&TB_iframe=true&amp;height=450&amp;width=1000" /><b>Add Part 5</b></a>';?>
      </td>
      <td width="150px" align="center">
         <? echo'<a title="Thêm Part 6" class="thickbox noborder a_detail" href="add_question_part_6.php?url='. base64_encode(getURL()) . '&record_id=' . $row["toty_id"] .'&TB_iframe=true&amp;height=450&amp;width=1000" /><b>Add Part 6</b></a>';?>
      </td>
      <td width="150px" align="center">
         <? echo'<a title="Thêm Part 7" class="thickbox noborder a_detail" href="add_question_part_7.php?url='. base64_encode(getURL()) . '&record_id=' . $row["toty_id"] .'&TB_iframe=true&amp;height=450&amp;width=1000" /><b>Add Part 7</b></a>';?>
      </td>
