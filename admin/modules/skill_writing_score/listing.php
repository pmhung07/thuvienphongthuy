...
<div id="listing">
   ...
   ?>
      ...
      <td width="50" align="center">
         ...
         <button class="bt_send_mail" type="button" style="width: 76px;background: #EEE;text-align: center;font-weight: bold;color: red;cursor: pointer;" name="<?=$row['lwr_id']?>">Send Mail</button>
         <?php } ?>
      </td>
      <td align="center" width="15">
   		<a href="edit.php?record_id=<?=$row['lwr_id']?>&user_id=<?=$row['lwr_use_id']?>&les_name=<?=$row['skl_les_name']?>&les_url=<?=$url?>&url=<?=base64_encode($_SERVER['REQUEST_URI'])?>" title="Bạn muốn sửa đổi bản ghi" rel="tooltip" class="edit">
