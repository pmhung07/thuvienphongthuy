...
$list->add("tec_audio","Add Content","string", 0, 0);
...
$total			= new db_count("SELECT count(*) AS count FROM type_test
                               ...
                               WHERE typ_type = 3 ".$list->sqlSearch());
...
<div id="listing">
   ...
   ?>
      ...
      <td align="" width="350px" style="color: red;">
          <table>
            <tr>
      ...
      <td width="150px" align="center">
         <? echo'<a title="Thêm Audio" class="thickbox noborder a_detail" href="add_paragraph.php?url='. base64_encode(getURL()) . '&record_id=' . $row["typ_id"] .'&TB_iframe=true&amp;height=450&amp;width=900" /><b>Add Content</b></a>';?>
      </td>
...
<style>
.a_detail{padding: 3px 15px;border:solid 1px;background:#EEE;border:#1C3A70 solid 1px;text-decoration:none;}
</style>