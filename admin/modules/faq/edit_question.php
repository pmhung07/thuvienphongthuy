<?
  ...
  $myform->add('que_content','que_content',0,0,'',1,'Bạn chưa nhập nội dung câu hỏi');
  ...
  if($submitform == "execute"){
    ...
    $myform->evaluate();
    $db_data = new db_query('SELECT * FROM faq_questions WHERE que_id = '.$record_id);
...
<?=template_top(translate_text("Add merchant"))?>
  <p align="center" style="padding-left:10px;">
    ...
    <?=$form->errorMsg($fs_errorMsg)?>
        <?=$form->textarea('Nội dung câu hỏi','que_content','que_content',$que_content,'',0,400,100)?>
