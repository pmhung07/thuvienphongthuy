...
function get_curent_language(){
	...
	if ($row=mysqli_fetch_array($db_current_language->result)){
...
function get_curent_path(){
	...
	if ($row=mysqli_fetch_array($db_current_path->result)){
...
function checkaccessmodule($module_id){
	...
	if ($row = mysqli_fetch_array($db_getright->result)){
...
function checkDeleteCategory($record_id){
	...
	if($module = mysqli_fetch_array($db_module->result)){
