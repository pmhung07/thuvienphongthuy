...
class BaoKimPayment 
{
	...
	// Mã merchante site 
	private $merchant_id = '9688';	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

	// Mật khẩu bảo mật
	private $secure_pass = '6d7ad20e66d056fc'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
