...
class BaoKimPayment 
{
	...
	// Mã merchante site 
	private $merchant_id = '16707';	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

	// Mật khẩu bảo mật
	private $secure_pass = '6df16d8f846ef2b1'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
