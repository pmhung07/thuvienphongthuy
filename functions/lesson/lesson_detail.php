<?php
    ...
    $rowCourses = mysqli_fetch_assoc($sqlCate->result);
    ...
    $num_rows   = mysqli_num_rows($result); unset($sqlSub);
    $time       = time();
            ...
            ><!--- tab_2 --->
               ...
               <div id="course_learn_part">
                  <div class="part_business_letter"><!--- Business letter --->
                     ...
                     $rowUnitMail = mysqli_fetch_assoc($sqlUnitMail);
                     ?>
                  ...
                  <div class="part_grammar"><!--- Grammar --->
                     ...
                     $rowUnitGram = mysqli_fetch_assoc($sqlUnitGram);
                     ?>
                  ...
                  <div class="part_vocabulary"><!--- Vocabulary --->
                     ...
                     $rowUnitVoca = mysqli_fetch_assoc($sqlUnitVoca);
                     ?>
